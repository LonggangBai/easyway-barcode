...
public class ZXingBarCode {
    ...
    public static void encode(String contents, String dest, int width, int height, int offset) throws WriterException, FileNotFoundException,
	    IOException {
     ...
     * 
     * 参考：<a
     * href="http://baike.baidu.com/view/13740.htm?fr=aladdin">百度百科-条形码</a>
     * 
     * @return String 校验码
     * 
     * @throws Exception
	...
	ZXingBarCode.encode(checksum("695", "32321", "2133"), imgPath, 500, 50, 20);

	System.out.println("解析结果:" + ZXingBarCode.decode(imgPath));
